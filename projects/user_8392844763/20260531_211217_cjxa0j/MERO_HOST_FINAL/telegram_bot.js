...
طُوِّر بواسطة: ᗴᒪᗰOᗪᗰᗴᑎ | @Sfvccf123
"""
...
# ========== إعدادات البوت ==========
BOT_TOKEN = "8744012007:AAHv8YjIq7WYV6Lv4esRQSGO51wZNJEudj0"
API_BASE_URL = os.environ.get("API_BASE_URL", "https://sharp-node-r3y.htmlhost.com")

# إيدي الأدمن على تليجرام
ADMIN_TELEGRAM_IDS = [8392844763]
...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE, edit=False):
    ...
    keyboard.append([InlineKeyboardButton("💬 تواصل مع المطور @Sfvccf123", url="https://Sfvccf123")])
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("💬 تواصل مع المطور @Sfvccf123", url="https://Sfvccf123")],
    ]
...
async def handle_api_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = api_request("/api/bot/verify", method="POST", data={"api_key": api_key})
    if not result or not result.get("success"):
        keyboard = [[InlineKeyboardButton("💬 تواصل مع المطور", url="https://t.me/Sfvccf123")]]
        await update.message.reply_text(
            "❌ *مفتاح API غير صالح!*\n\n"
            "تحقق من الكود وحاول مرة أخرى\n"
            "أو تواصل مع المطور: @Sfvccf123",
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup(keyboard),
        )
        return WAITING_FOR_API_KEY
