    ...
    try {
        ...
        if (profilePhotos.photos.length > 0) {
            ...
            await XeonBotInc.replyWithPhoto(ownerPhoto, {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{ text: 'OWNER', url: "https://t.me/MIDO_x13" }, { text: 'CHANNEL', url: "https://t.me/MIDO_x12" }, { text: 'GROUP', url: "https://t.me/MIDO_x12" }]
                    ]
                }
            });
        } else {
            ...
            await XeonBotInc.reply(lang.first_chat(BOT_NAME, user.full_name), {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{ text: 'OWNER', url: "https://t.me/MIDO_x12" }, { text: 'CHANNEL', url: "@lo_tus_19" }, { text: 'GROUP', url: "@lo_tus_19" }]
                    ]
                }
            });
        }
        ...
        await XeonBotInc.reply(lang.first_chat(BOT_NAME, user.full_name), {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: 'OWNER', url: "https://t.me/MIDO_x12" }, { text: 'GROUP', url: "https://t.me/MIDO_x12" }]
                ]
            }
        });
    }
